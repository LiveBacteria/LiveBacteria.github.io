...
let employeeArray = [
    ...
    {
        name: "Corpuz, Zalhdee,",
        url: "https://cleanharbors.platform.telogis.com/handler/driver/dailylog.ashx?DriverId=1332941582&Date="
    },
    {
        name: "Greer, Peter,",
    ...
    {
        name: "Jacobs, Frederick,",
        url: "https://cleanharbors.platform.telogis.com/handler/driver/dailylog.ashx?DriverId=1308553110&Date="
    },
    {
    ...
    {
        name: "Hippe, Bruce,",
        url: "https://cleanharbors.platform.telogis.com/handler/driver/dailylog.ashx?DriverId=1308556872&Date="
    },
    {
...
function devModeToggle() {
    if (devMode === false && prompt("Attempting to Activate Developer Mode: \nEnter credentials: ") === "admin64") {
        devMode = true;
        $(".footNotation").html = ("All Rights Reserved. Released under the MIT license. Copyright Tyler Poore " + y + ", created for general use Clean Harbors© in-house. Logos and Images used are owned, and or managed by Clean Harbors©.<br>AppVersion " + currVersion);
        alert("This is a WIP Build, please take caution.\nAppVersion: " + currVersion + "\nDeveloper Mode Activated");
        unlockWIPMethods(devMode);
    } else {
        devMode = false;
        $(".footNotation").html = ("All Rights Reserved. Released under the MIT license. Copyright Tyler Poore " + y + ", created for general use Clean Harbors© in-house. Logos and Images used are owned, and or managed by Clean Harbors©.<br>AppVersion " + currVersion + "lv");
